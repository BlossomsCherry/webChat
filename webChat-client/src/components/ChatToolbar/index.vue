<template>
  <div class="toolbar">
    ...
    <div class="toolbar-left">
      <div
        :class="['toolbar-left-item', ' flex_center', { 'active-menu': opt1.show }]"
      ...
      <div
        :class="['toolbar-left-item', ' flex_center', { 'active-menu': opt2.show }]"
      ...
      <div
        :class="['toolbar-left-item', ' flex_center', { 'active-menu': opt3.show }]"
      ...
      <div
        :class="['toolbar-left-item', ' flex_center', { 'active-menu': opt4.show }]"
        @click.stop="openBox(4)"
      >
        <icon name="toolbar-love" class="m_r5" scale="1.6" />
        收藏
      </div>
      <el-popover placement="top" title="添加作者微信" trigger="click"> </el-popover>
    </div>
...
export default {
  ...
  methods: {
    ...
    closeBox() {
      ...
      const keys = Object.keys(this._data).filter((t) => t.search('opt') !== -1)
